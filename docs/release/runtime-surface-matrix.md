...
| Native Ubuntu/macOS CI | validation and complete unittest lifecycle | VERIFIED | `main` run [32452404953](https://github.com/SII-k7/codex-air/actions/runs/32452404953), Ubuntu and macOS with Python 3.11 and 3.13 | 2026-08-21 |
| Windows PowerShell | install, rollback, uninstall | VERIFIED | Local Windows PowerShell 5.1 lifecycle contract passed | 2026-08-21 |
| Native Windows CI | validation and complete install lifecycle | VERIFIED | `main` run [32452409276](https://github.com/SII-k7/codex-air/actions/runs/32452409276), Windows Server 2022 and `windows-latest`, Windows PowerShell and PowerShell 7 | 2026-08-21 |
